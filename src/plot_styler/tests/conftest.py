"""
Configuration of PlotStyler tests
"""
...
STYLES_PATH = Path(plot_styler.__path__[0], "styles")
...
def styles_in_plotstyler_per_folder():
    """
    Output: dictionary of styles per folder in PlotStyler
    """
    styles_per_folder = {}
