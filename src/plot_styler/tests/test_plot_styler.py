"""Test suite of PlotStyler, a library of matplotlib stylesheets and utilities for styling
"""
...
def test_styles_existence(styles_in_plotstyler_per_folder):
    """Check all styles are available in matplotlib."""
    for folder, styles in styles_in_plotstyler_per_folder.items():
...
def test_usage_of_each_style(
    xy_example_values, styles_in_plotstyler_per_folder, tmp_path,
):
